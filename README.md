...
### Deployment Info
Deployment dilakukan dengan Cloudflared dengan domain yang di-register dari namecheap.com (.me diambil dari GitHub Student Pack) serta virtualisasi web server dan database server melalui docker-compose.