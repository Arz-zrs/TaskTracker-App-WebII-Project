        ...
        <div>
            ...
            <nav class="mt-6 px-3 space-y-1">
                ...
                <a href="<?= site_url('timeline') ?>"
                    class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all duration-200 <?= (strpos($current_uri, 'timeline') !== false) ? 'bg-[#E0E7FF] text-[#4F46E5]' : 'text-slate-600 hover:bg-[#E0E7FF]/40 hover:text-slate-900' ?>">                    
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.2" stroke="currentColor" class="w-5 h-5">  
        ...
        <header class="h-20 bg-transparent flex items-center justify-between px-8 sticky top-0 z-30 shrink-0">
            ...
            <div class="flex items-center gap-6">
                ...
                <a 
                    ...
                    class="text-slate-600 hover:text-slate-900 transition-colors duration-200 relative p-1.5 hover:bg-white/50 rounded-lg inline-flex items-center justify-center"
                    title="Notifications"
                >
                ...
                <a 
                    ...
                    class="text-slate-600 hover:text-slate-900 transition-colors duration-200 p-1.5 hover:bg-white/50 rounded-lg inline-flex"
                    title="Settings"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <?php if (! empty($avatar)): ?>
                        <img 
                            src="<?= base_url($avatar) ?>" 
                            alt="User Avatar"
                            class="h-10 w-10 rounded-xl object-cover border border-indigo-200"
                        >
                    <?php else: ?>
